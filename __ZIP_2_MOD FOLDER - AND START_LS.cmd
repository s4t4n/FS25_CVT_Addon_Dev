...
echo.
echo ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ 
C:\Programme\7-Zip\7z.exe a "%~dp0"%name_parent% -w "%~dp0"* -xr!*.cmd -xr!.* -xr!*.bak -xr!*.akt -xr!*.7z -xr!*.zip -xr!*.png -xr!*.gsp -xr!*.gspu -xr!*.jpg -xr!db -xr!Old -xr!VCA_modified -xr!log -xr!*.psd -xr!screenshots -xr!_* -xr!_ZiP_log.txt -xr!offline -tzip
echo ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ 
echo.
echo.
echo.
